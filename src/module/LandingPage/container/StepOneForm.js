...
class StepOneForm extends Component {
  ...
  handleChange = (e) => {
    ...
    if (e.target.id == "address1") {
      this.validateAddress1(e.target.value);
    }
    if (e.target.id == "address2") {
      this.validateAddress2(e.target.value);
    }
    if (e.target.id == "citizen") {
      this.validateCitizen(e.target.value);
    }
  ...
  validateLastName = (lastName) => {
    ...
    if (String(lastName).trim() === "") {
      ...
      formIsValid = false;
    } else if (patterns.test(lastName)) {
      formIsValid = false;
  ...
  validateAddress1 = (address1) => {
    let address1Error = this.state.address1Error;
    let formIsValid = this.state.formIsValid;
  ...
  validateAddress2 = (address2) => {
    let address2Error = this.state.address2Error;
    let formIsValid = this.state.formIsValid;
    if (String(address2).trim() === "") {
      address2Error = "*Please enter your address.";
      formIsValid = false;
    } else {
      address2Error = "";
      formIsValid = true;
  ...
  validateCitizen = (citizen) => {
    let citizenError = this.state.citizenError;
    let formIsValid = this.state.formIsValid;
    var passportpattern = new RegExp("^([S s]){1}([G g]){1}([0-9]){10}$");
    if (String(citizen).trim() === "") {
      citizenError = "*Please enter your Passport number";
      formIsValid = false;
    } else if (!passportpattern.test(citizen)) {
      //use Rejex- length== 12 character week 3 wednesday.
      //first to two sg and last has to be digits
      citizenError =
        "invalid passport its must start with SG(sg) and total length should be 12 characters";
      formIsValid = false;
    } else {
      citizenError = "";
      formIsValid = true;
  ...
  handleSubmit = (e) => {
    ...
    if (
      ...
      this.validateAddress1(this.state.address1) &&
      this.validateAddress2(this.state.address2) &&
      this.validateCitizen(this.state.citizen) &&
        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12}>
            <TextField
              ...
              variant="standard"
            />
            <p style={{ color: "red" }}>{this.state.address1Error}</p>
          </Grid>
          ...
          <Grid item xs={12}>
            <TextField
              ...
              variant="standard"
            />
            <p style={{ color: "red" }}>{this.state.address2Error}</p>
          </Grid>
          ...
          <Grid item xs={12} sm={6}>
            <TextField
              ...
              label="citizen"
              fullWidth
              autoComplete="shipping citizen"
              variant="standard"
            />
            <p style={{ color: "red" }}>{this.state.citizenError}</p>
          </Grid>
          ...
          <Grid item xs={12} sm={6}>
            ...
            <Grid item xs={12} sm={6}>
              <TextField
                ...
                variant="standard"
              />
              <p style={{ color: "red" }}>{this.state.numberError}</p>
            </Grid>
            {/* <Link to="/StepTwoForm"> */}
            <div class="btn">
              <Button
