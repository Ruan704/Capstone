...
const AboutWildlife = () => {
  return (
    <div className="aboutwildlife">
      <h1 style={{fontSize:"35px", fontWeight: 'bold',  color:"green" , textAlign:"center",fontFamily:"Lato" }}>About Wildlife Protection</h1>

      <div className="first">
        <div className="des-text">
          <p style={{fontSize:"35px", fontWeight: 'bold',  color:"#996600", fontFamily:"Lato", }}>CHARTING A CHANGING HABITAT</p>
          <br></br><br></br>
          <p style={{fontSize:"20px", fontWeight: 'bold', display: "inline", fontFamily:"Lato"}}>
