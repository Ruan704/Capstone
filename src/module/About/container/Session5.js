    ...
    <Timeline position="alternate" style={{marginLeft:"600px"}}>
      <TimelineItem>
        ...
        <TimelineContent>
          ...
          />
          <h1 style={{ color: "purple",fontFamily:"Lato", }}>
            1973: WWP First Wildlife Sanctuary
          </h1>
          <h2 style={{fontFamily:"Lato", fontSize: "20px"}}>
      ...
      <TimelineItem>
        ...
        <TimelineContent>
          ...
          />
          <h1 style={{ color: "purple",fontFamily:"Lato" }}>1974: 1st five projects approved</h1>
          <h2 style={{ textAlign: "center" , fontFamily:"Lato", fontSize: "20px"}}>
      ...
      <TimelineItem>
        ...
        <TimelineContent>
          <img
            ...
            style={{ width: "400px", height: "300px", margin: "center" }}
          />
          <h1 style={{ color: "purple",fontFamily:"Lato" }}>2000: Sanctuary Expanded</h1>
          <h2 style={{ textAlign: "center" , fontFamily:"Lato", fontSize: "20px"}}>
